...
- Visual Keyboard (Detects your key presses)
- (Soon) User test history
- (Soon) User stat graphs
- (Soon) Computed WPM
- (Soon) Other speed metrics (by time, by word count)
- (Soon) Test type variation (pure words, with numbers, with symbols, with cases, quotes)
